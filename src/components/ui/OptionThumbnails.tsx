...
export function EyesThumb({ id, color }: { id: string; color: string }) {
  ...
  switch (id) {
    ...
    case 'eyes-4': // Happy
      return (<svg viewBox="0 0 80 80" className="w-full h-full"><path d="M16 42 Q26 30 36 42" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round"/><path d="M44 42 Q54 30 64 42" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round"/><circle cx="26" cy="50" r="1.5" fill="white" opacity="0.4"/><circle cx="54" cy="50" r="1.5" fill="white" opacity="0.4"/></svg>);
    case 'eyes-5': // Sad
    ...
    case 'eyes-7': // Closed
      return (<svg viewBox="0 0 80 80" className="w-full h-full"><path d="M16 40 Q26 50 36 40" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round"/><path d="M44 40 Q54 50 64 40" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round"/><circle cx="26" cy="34" r="1.5" fill="white" opacity="0.4"/><circle cx="54" cy="34" r="1.5" fill="white" opacity="0.4"/></svg>);
    case 'eyes-8': // Sleepy
